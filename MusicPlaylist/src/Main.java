...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("In the end",3.5);
        album.addSong("Crawling",5.0);
        album.addSong("Faint",3.5);
        album.addSong("Burn It Down",3.5);
        albums.add(album);
        ...
        albums.get(0).addToPlayList("Crawling",playList_1);
        albums.get(0).addToPlayList("Faint",playList_1);
        albums.get(0).addToPlayList("Burn It Down",playList_1);
